...
Start:
    ; tempoarily save partition-start-lba to ebx
    mov     ebx, [ds:si + MBRPartEnt_StartLBA]
...
MSG_BEGIN 4
    NewMessage Booting,        "BOOT"
    NewMessage LoaderNotFound, "MISS"
    NewMessage FailedToRead,   "FAIL"
MSG_END
